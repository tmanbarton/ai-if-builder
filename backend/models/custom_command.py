...
class CustomCommand(BaseModel):
    ...
    custom_default_behavior: bool = Field(description="Whether or not the fallback should be custom or the game default for when no criteria are met for this command to do something. (usually, this is a custom behavior)")
